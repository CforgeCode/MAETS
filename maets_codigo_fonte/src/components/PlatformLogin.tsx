  ...
  return (
    <div className="bg-steam-blue p-4 rounded">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-steam-blue-light p-4 rounded flex flex-col items-center">
          <div className="w-16 h-16 bg-steam-dark rounded-full mb-2 flex items-center justify-center">
            <span className="text-accent">Steam</span>
          </div>
          <h3 className="text-white mb-2">Steam</h3>
          <button className="bg-steam-accent">Conectar</button>
        </div>
        ...
        <div className="bg-steam-blue-light p-4 rounded flex flex-col items-center">
          ...
          <button className="bg-steam-blue-light">Explorar</button>
        </div>
      </div>
    </div>
  );
