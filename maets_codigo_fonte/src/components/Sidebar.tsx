...
const Sidebar: React.FC = () => {
  return (
    <aside className="bg-steam-blue-light p-4 rounded">
      <div className="flex flex-col gap-4">
        <div className="p-2 bg-steam-blue rounded">
          <h3 className="text-accent">Minhas Plataformas</h3>
          <ul className="flex flex-col gap-2 p-2">
            <li className="flex items-center gap-2">
              <div className="w-6 h-6 bg-steam-dark rounded"></div>
              <span>Steam</span>
            </li>
            <li className="flex items-center gap-2">
              <div className="w-6 h-6 bg-steam-dark rounded"></div>
        ...
        <div className="p-2 bg-steam-blue rounded">
          ...
          <ul className="flex flex-col gap-2 p-2">
            <li className="flex items-center gap-2">
              <div className="w-6 h-6 bg-steam-dark rounded-full"></div>
              <span>Jogador1</span>
              <span className="text-steam-success">●</span>
            </li>
            <li className="flex items-center gap-2">
              <div className="w-6 h-6 bg-steam-dark rounded-full"></div>
              <span>Jogador2</span>
